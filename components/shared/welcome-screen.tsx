...
export function WelcomeScreen() {
  ...
  return (
    <AnimatePresence>
      ...
      >
        <motion.div
          className="relative w-full max-w-6xl mx-4 bg-card border border-border rounded-2xl shadow-2xl overflow-hidden"
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-8 md:p-12 bg-gradient-to-br from-primary/5 via-primary/10 to-primary/5">
              ...
              >
                <div className="relative">
                  ...
                  <motion.div
                    className="absolute -top-1 -right-1 w-6 h-6 rounded-full bg-primary/20 backdrop-blur-sm flex items-center justify-center"
                    animate={{
                      scale: [1, 1.2, 1],
                      opacity: [0.5, 0.8, 0.5],
                    }}
