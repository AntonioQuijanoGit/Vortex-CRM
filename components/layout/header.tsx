...
export function Header() {
  ...
  return (
    <header className="flex h-16 items-center justify-between border-b border-border bg-background px-2 sm:px-4 md:px-6 gap-2 md:pl-6 pl-14 sm:pl-4" role="banner">
      <form onSubmit={handleSearch} className="flex-1 min-w-0 max-w-md" role="search">
        <div className="relative">
          ...
          <Input
            ...
            className="pl-8 sm:pl-10 cursor-pointer text-sm sm:text-base h-9 sm:h-10"
